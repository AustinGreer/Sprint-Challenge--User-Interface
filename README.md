...
1. If you were to describe semantic HTML to the next cohort of students, what would you say?
        ...
        Semantic HTML is HTML that has meaning. it is useful in that it is more readable for both humans and machines.
...
4. Explain why git is valuable to a team of developers.
        ...
        It makes it much easier for teams to work together on a project. It also allows you to make commits, which basically means you can go back to previous code.

5. Define mobile-first design in your own words.

        You begin by designing your webpage by the smallest screen and work up to the largest screen.
